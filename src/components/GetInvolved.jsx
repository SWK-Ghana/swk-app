        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 xs:gap-6 sm:gap-7 md:gap-8 mb-8 xs:mb-12 sm:mb-14 md:mb-16 lg:mb-20">
            <div className="bg-white rounded-lg xs:rounded-xl p-5 xs:p-6 sm:p-7 md:p-8 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm xs:text-base text-gray-800 mb-5 xs:mb-6 leading-relaxed">Give your time and skills to support our community initiatives and make a direct impact.</p>
            ...
            <div className="bg-white rounded-lg xs:rounded-xl p-5 xs:p-6 sm:p-7 md:p-8 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm xs:text-base text-gray-800 mb-5 xs:mb-6 leading-relaxed">Support our mission financially and help us expand our programs and reach more people.</p>
            ...
            <div className="bg-white rounded-lg xs:rounded-xl p-5 xs:p-6 sm:p-7 md:p-8 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm xs:text-base text-gray-800 mb-5 xs:mb-6 leading-relaxed">Collaborate with us as an organization or business to create meaningful partnerships.</p>
              ...
              {[
                ...
                <div key={name} className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 text-sm xs:text-base">{text}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-xl xs:rounded-2xl p-4 xs:p-6 sm:p-8 md:p-10 shadow-sm border border-gray-200">
            ...
            <p className="text-sm xs:text-base text-gray-800 mb-6 text-center max-w-xl mx-auto">Have questions or want to learn more? We'd love to hear from you!</p>
            {contactStatus === 'success' ? (
              <div className="flex flex-col items-center py-10 text-center">
                ...
                <p className="text-sm text-gray-800 mb-5">Thank you for reaching out. We'll get back to you soon.</p>
              ...
              <form className="max-w-2xl mx-auto space-y-5" onSubmit={handleContactSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input type="text" id="gi-firstName" required value={firstName} onChange={(e) => setFirstName(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="Your first name" />
                  </div>
                  <div>
                    <label htmlFor="gi-lastName" className="block text-sm font-medium text-gray-700 mb-2">Last Name</label>
                    <input type="text" id="gi-lastName" required value={lastName} onChange={(e) => setLastName(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="Your last name" />
                  </div>
                </div>
                <div>
                  <label htmlFor="gi-email" className="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
                  <input type="email" id="gi-email" required value={email} onChange={(e) => setEmail(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="your.email@example.com" />
                </div>
                <div>
                  <label htmlFor="gi-message" className="block text-sm font-medium text-gray-700 mb-2">Message</label>
                  <textarea id="gi-message" rows={4} required value={message} onChange={(e) => setMessage(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="Tell us how you'd like to get involved..." />
                </div>
            ...
            {volunteerStatus === 'success' ? (
              ...
              <form className="space-y-4" onSubmit={handleVolunteerSubmit}>
                ...
                <div>
                  ...
                  <select required id="v-role" value={volunteerRole} onChange={(e) => setVolunteerRole(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E] bg-white">
                ...
                <div>
                  ...
                  <select required id="v-hours" value={volunteerHours} onChange={(e) => setVolunteerHours(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E] bg-white">
            ...
            {donateStatus === 'success' ? (
              ...
              <form className="space-y-4" onSubmit={handleDonateSubmit}>
                <div>
                  ...
                  <input required id="d-name" type="text" value={donorFullName} onChange={(e) => setDonorFullName(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="Your full name" />
                </div>
                <div>
                  <label htmlFor="d-email" className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                  <input required id="d-email" type="email" value={donorEmail} onChange={(e) => setDonorEmail(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="your.email@example.com" />
                </div>
                <div className="grid grid-cols-3 gap-4">
                  <div className="col-span-2">
                    <label htmlFor="d-amount" className="block text-sm font-medium text-gray-700 mb-1">Amount (optional)</label>
                    <input id="d-amount" type="number" min={0} step="0.01" value={donationAmount} onChange={(e) => setDonationAmount(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="e.g. 200" />
                  </div>
                  <div>
                    <label htmlFor="d-currency" className="block text-sm font-medium text-gray-700 mb-1">Currency</label>
                    <select id="d-currency" value={donationCurrency} onChange={(e) => setDonationCurrency(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E] bg-white">
                ...
                <div>
                  ...
                  <textarea id="d-message" rows={3} value={donationMessage} onChange={(e) => setDonationMessage(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="Preferred payment method, purpose, etc." />
                </div>
            ...
            {partnerStatus === 'success' ? (
              ...
              <form className="space-y-4" onSubmit={handlePartnerSubmit}>
                <div>
                  ...
                  <input required id="p-org" type="text" value={partnerOrgName} onChange={(e) => setPartnerOrgName(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="Your organization" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="p-name" className="block text-sm font-medium text-gray-700 mb-1">Contact name</label>
                    <input required id="p-name" type="text" value={partnerContactName} onChange={(e) => setPartnerContactName(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="Your name" />
                  </div>
                  <div>
                    <label htmlFor="p-email" className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                    <input required id="p-email" type="email" value={partnerEmail} onChange={(e) => setPartnerEmail(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="you@email.com" />
                  </div>
                </div>
                <div>
                  <label htmlFor="p-message" className="block text-sm font-medium text-gray-700 mb-1">How would you like to partner?</label>
                  <textarea required id="p-message" rows={4} value={partnerMessage} onChange={(e) => setPartnerMessage(e.target.value)} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#78C31E]" placeholder="Tell us what partnership you have in mind…" />
                </div>

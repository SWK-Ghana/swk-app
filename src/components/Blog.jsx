    ...
    <main className="min-h-screen bg-gradient-to-br from-white to-white">
      <div className="container mx-auto px-3 xs:px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-10 xs:py-12 sm:py-14 md:py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-base xs:text-lg text-gray-800 mb-8 text-center max-w-2xl mx-auto">
            ...
            {CATEGORIES.map(cat => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-semibold transition-colors ${
                  activeCategory === cat
                    ? 'bg-[#78C31E] text-white'
                    : 'bg-white text-gray-800 border border-gray-200 hover:border-[#78C31E]'
                }`}
              >
                {cat}
              </button>
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20 bg-white rounded-2xl border border-gray-200">
              ...
              <p className="text-gray-700 text-sm">Check back soon for updates from SWK Ghana.</p>
            </div>
          ) : (
              ...
              {filtered.map(post => (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <p className="text-sm text-gray-800 leading-relaxed flex-1 line-clamp-3">{post.excerpt}</p>
                    <div className="mt-4 text-sm font-semibold text-[#78C31E] flex items-center gap-1">
                      Read more
